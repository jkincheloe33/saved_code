...
const individualWambiFromTeamMember = async ({ cpcContent, cpcUrl, recipientName, senderName }) => {
  let template = `
    <mjml>
      <mj-head>
        <mj-attributes>
      ...
      <mj-body>
        <mj-section>
          <mj-column>
            ...
            <mj-text align="left" font-size="14px" font-weight="400" line-height="24px">
              Keep up the good stuff -- it's getting you noticed! ${senderName} recognized you. 
            </mj-text>
  ...
  return {
    ...
    subject: `${senderName} sent you a Wambi!`,
  }
}

module.exports = individualWambiFromTeamMember
