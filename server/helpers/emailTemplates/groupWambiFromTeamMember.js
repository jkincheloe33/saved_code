...
const groupWambiFromTeamMember = async ({ cpcContent, cpcUrl, senderName }) => {
  let template = `
    <mjml>
      <mj-head>
        <mj-attributes>
      ...
      <mj-body>
        <mj-section>
          <mj-column>
            ...
            <mj-text align="left" font-size="14px" font-weight="400" line-height="24px">
              Your teamwork is getting noticed! ${senderName} recognized your group with a Wambi.
            </mj-text>
  ...
  return {
    ...
    subject: `${senderName} sent your group a Wambi!`,
  }
}

module.exports = groupWambiFromTeamMember
